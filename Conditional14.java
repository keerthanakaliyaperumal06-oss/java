...
public class Conditional14 {
    public static void main(String[] args) {
        ...
        double monthlyBeforeDiscount = baseFee + accessFee + addOnFee;
        double monthlyTotal = monthlyBeforeDiscount * (1 - discount / 100);
        double contractTotal = monthlyTotal * contractMonths;

        double monthToMonthTotal = monthlyBeforeDiscount * contractMonths;
